...
<table>
  <tbody>
  eaderAlreadyExists MimeReaderMalformedHeader MimeReaderResetCalledBeforeEOF MimeReaderTruncated MimeVersionHeaderInvalid MimeWriterInvalidStateForClose MimeWriterInvalidStateForContent MimeWriterInvalidStateForHeader MimeWriterInvalidStateForStartPart MimeWriterInvalidStateForStartPreface MissingGetSchemaMethod MissingSchemaType MixedContentNotSupported MtomBoundaryInvalid MtomBufferQuotaExceeded MtomContentTransferEncodingNotPresent MtomContentTransferEncodingNotSupported MtomContentTypeInvalid MtomDataMustNotContainXopInclude MtomExceededMaxSizeInBytes MtomInvalidCIDUri MtomInvalidEmptyURI MtomInvalidStartUri MtomInvalidTransferEncodingForMimePart MtomMessageContentTypeNotFound MtomMessageInvalidContent MtomMessageInvalidContentInMimePart MtomMessageInvalidMimeVersion MtomMessageNotApplicationXopXml MtomMessageNotMultipart MtomMessageRequiredParamNotSpecified MtomMimePartReferencedMoreThanOnce MtomPartNotFound MtomRootContentTypeNotFound MtomRootNotApplicationXopXml MtomRootPartNotFound MtomRootRequiredParamNotSpecified MtomRootUnexpectedCharset MtomRootUnexpectedType MtomXopIncludeHrefNotSpecified MtomXopIncludeInvalidXopAttributes MtomXopIncludeInvalidXopElement MultipleIdDefinition MustContainOnlyLocalElements NameCannotBeNullOrEmpty NoAsyncWritePending NoConversionPossibleTo NoGetMethodForProperty NonAttributedSerializableTypesMustHaveDefaultConstructor NonOptionalFieldMemberOnIsReferenceSerializableType NoSetMethodForProperty NullKnownType NullValueReturnedForGetOnlyCollection ObjectTableOverflow OffsetExceedsBufferSize OnlyDataContractT